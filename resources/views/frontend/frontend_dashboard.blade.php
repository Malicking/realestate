...
<title>MalickRoi - @yield('title')</title>
...
<body>
    ...
    <!-- boostrap pour chat live -->
    <script src="{{ asset('frontend/assets/chatlive/propper.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/chatlive/bootstrap.min.js') }}"></script>
