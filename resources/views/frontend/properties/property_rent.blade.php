...
<section class="page-title-two bg-color-1 centred">
    ...
    <div class="auto-container">
        <div class="content-box clearfix">
            <h1>Propriétés en location</h1>
            <ul class="bread-crumb clearfix">
                <li><a href="{{ route('home.page') }}">Accueil</a></li>
                <li>Liste des pripriétés</li>
            </ul>
        </div>
    </div>
</section>
                ...
                <div class="property-content-side">
                    <div class="item-shorting clearfix">
                        <div class="left-column pull-left">
                            <h5>{{ count($rentProps) }} <span>résultats trouvés</span></h5>
                        </div>
                    </div>
                    <div class="wrapper list">
                        <div class="deals-list-content list-item">

                            @foreach ($rentProps as $item)
                    ...
                    <div class="pagination-wrapper">
                        {{ $rentProps->links('vendor.pagination.custom') }}
                    </div>
                </div>
            </div>
        </div>
