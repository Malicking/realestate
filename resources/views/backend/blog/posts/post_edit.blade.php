    ...
    <div class="row profile-body">
        ...
        <div class="col-md-12 col-xl-12 middle-wrapper">
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Editer un article posté</h6>
                        <form method="post" class="forms-sample" action="{{ route('blog.post.update') }}" id="myForm" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="post_title" class="form-control" autocomplete="off" value="{{ $postData->post_title }}" placeholder="Entrez le titre de l'article...">
                                    </div>
                                </div><!-- Col -->
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="blogcat_id" id="BlogCat" class="form-select">
                                            ...
                                            <option value="{{ $item->id }}" {{ $item->id == $postData->blogcat_id ? 'selected' : '' }}>
                                                {{ $item->category_name }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <img src="{{ !empty($postData->post_image) ? url($postData->post_image) : url('upload/no_image.jpg') }}" id="postImg" width="150">
                                    </div>
                                </div><!-- Col -->
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <textarea name="short_desc" id="shortDesc" rows="3" class="form-control">{{ $postData->short_desc }}</textarea>
                                </div>
                                ...
                                <div class="col-md-12 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <input name="post_tags" id="tags" value="{{ $postData->post_tags }}" />
                                        </div>
                                    </div>
                                </div>
                            </div><!-- Row -->
