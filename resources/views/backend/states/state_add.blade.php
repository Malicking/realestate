    ...
    <div class="row profile-body">
        ...
        <div class="col-md-12 col-xl-12 middle-wrapper">
            <div class="row">
                <div class="card">
                    <div class="card-body">      
                        <h6 class="card-title">Ajout d'une nouvelle région</h6>
                        <hr>
                        
                        <form class="forms-sample" method="POST" action="{{ route('state.store') }}" id="myForm" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="state_name" class="form-control" autocomplete="off" placeholder="Entrez le nom de la région...">
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="mb-3">
