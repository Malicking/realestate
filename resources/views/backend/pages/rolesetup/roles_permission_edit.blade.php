    ...
    <div class="row profile-body">
        ...
        <div class="col-md-8 col-xl-8 middle-wrapper">
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Modifier les privilèges d'un rôle</h6>
                        <hr>

                        <form id="myForm" class="forms-sample" method="POST" action="{{ route('roles.permission.update', $role->id) }}">
                            @csrf

                            <input type="hidden" name="id" value="{{ $role->id }}">

                            <div class="form-group mb-5">
                                <label class="form-label" for="GroupName">Rôle</label>
                ...
                @endphp
                                <div class="col-3">
                                    <div class="form-check mb-2">
                                        <input type="checkbox" class="form-check-input" id="Grp{{ $grp->group_name }}" {{ App\Models\User::roleHasPermissions($role, $permissions) ? 'checked' : '' }}>
                                ...
                                <div class="col-9">
                                    ...
                                    <div class="form-check mb-2">
                                        <input type="checkbox" class="form-check-input" id="checkChecked{{ $perm->id }}" name="permission[]" value="{{ $perm->id }}" {{ $role->hasPermissionTo($perm->name) ? 'checked' : '' }}>
