...
<div class="page-content">
    ...
    @if ($status == 'active')
        <h4>Votre compte est <span class="text-success">activé</span></h4>
    @else
        <h4>Votre compte est <span class="text-danger">désactivé</span></h4>
        <p class="text-danger mb-4 fw-bold">
            Veuillez patienter l'administrateur vérifiera et approuvera votre compte.
        </p>
    @endif
                    ...
                    <div class="d-flex justify-content-between align-items-baseline mb-2">
                        ...
                        <div class="dropdown mb-2">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton4">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="javascript:;">
                                    <i data-feather="printer" class="icon-sm me-2"></i> <span class="">Print</span>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:;">
                                    <i data-feather="download" class="icon-sm me-2"></i> <span class="">Download</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-baseline mb-2">
                        ...
                        <div class="dropdown mb-2">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton7">
                                <a class="dropdown-item d-flex align-items-center" href="javascript:;">
                                    <i data-feather="eye" class="icon-sm me-2"></i> <span class="">View</span></a>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:;">
                                    <i data-feather="edit-2" class="icon-sm me-2"></i> <span class="">Edit</span>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:;">
