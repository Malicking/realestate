            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" class="forms-sample" action="{{ route('agent.property.update') }}" id="myForm" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="amenities_id[]" class="js-example-basic-multiple form-select" multiple="multiple" data-width="100%">
                                            @foreach ($amenities as $item)
                                                <option value="{{ $item->id }}" class="bg-none" {{ in_array($item->amenitie_name, $property_ami) ? 'selected' : '' }}>
                                                    {{ $item->amenitie_name }}
                                                </option>
                                            @endforeach
                                        </select>
        ...
        <div class="col-md-12 col-xl-12 middle-wrapper">
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">
                            Actualiser l'image principale de la propriété
                        </h6>


                        <form method="post" class="forms-sample" action="{{ route('agent.property.update.thumbnail') }}" id="myForm" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <input type="file" name="property_thumbnail" class="form-control mb-3" onchange="propThumbUrl(this)">

                                                <div class="mt-3">
                                                    <img src="{{ !empty($propertyData->property_thumbnail) ? url($propertyData->property_thumbnail) : url('upload/no_image.jpg')  }}" style="width: 80px; height:80px;" id="propThmb">
                                                </div>
                                            </td>
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" class="forms-sample" action="{{ route('agent.property.multiImg.update') }}" id="myForm" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        @foreach ($multiImg as $key => $img)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="{{ route('agent.property.multiImg.delete', $img->id) }}" class="btn btn-danger" id="delete">
                                                        Supprimer
                                                    </a>
                                                </td>
                                            </tr>
                        ...
                        <form method="post" class="forms-sample" action="{{ route('agent.property.multiImg.store') }}" id="myForm" enctype="multipart/form-data">
                            @csrf
...
<!-- Affichage de l'image principale (thumbnail) -->
<script type="text/javascript">
    function propThumbUrl(input) {
        if (input.files && input.files[0]) {
            var reader = new FileReader();
            reader.onload = function (e) {
                $('#propThmb').attr('src', e.target.result).width(80).height(80);
            };
            reader.readAsDataURL(input.files[0]);
        }
    }
