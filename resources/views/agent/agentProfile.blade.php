        ...
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="position-relative">
                    ...
                    <figure class="overflow-hidden mb-0 d-flex justify-content-center">
                        <img src="{{ (!empty($profileData->cover_photo) ? (url('upload/agents/covers/'.$profileData->cover_photo)) : url('upload/cover_default.png')) }}" class="rounded-top" alt="profile cover">
                    </figure>
                    <div class="d-flex justify-content-between align-items-center position-absolute top-90 w-100 px-2 px-md-4 mt-n4">
                        <div>
                            <img class="wd-80 rounded-circle" src="{{ !empty($profileData->photo) ? url('upload/agents/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="profile">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('agent.profile.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <img class="wd-80 rounded" style="height: 75px;" src="{{ !empty($profileData->photo) ? url('upload/agents/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="profile" id="showImage">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <img class="wd-80 rounded" style="height: 75px;" src="{{ !empty($profileData->cover_photo) ? url('upload/agents/covers/'.$profileData->cover_photo) : url('upload/cover_default.png') }}" alt="profile" id="showCoverImg">
                                    </div>
                                </div>
                            </div>
