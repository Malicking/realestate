...
<body>
    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                ...
                <h2 style="color: darkblue; font-size: 26px;"><strong>MalickRoi</strong></h2>
            </td>
            <td align="right">
                <pre class="font" >
                    Siège Social de MalickRoi
                    Email:worldpython3@gmail.com <br>
                    Mob: +224 628 00 00 00 <br>
    ...
    <table width="100%" style="background: #F7F7F7; padding:0 5 0 5px;" class="font">
        <tr>
            ...
            <td>
                <p class="font">
                    <h3><span style="color: darkblue;">Facture N°: </span> #{{ $packageData->invoice }}</h3>
