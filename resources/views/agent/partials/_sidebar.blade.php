<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            @if ($status == 'active')
                <li class="nav-item nav-category">MalickRoi</li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="property">
                        <ul class="nav sub-menu">
                            <li class="nav-item">
                                <a href="{{ route('agent.property.all') }}" class="nav-link">
                                    Propriétés
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('agent.property.message.new') }}" class="nav-link">
                                    Message sur mes propriétés
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('agent.property.schedule.request') }}" class="nav-link">
                                    Demandes de visite
                                </a>
                            </li>
                        </ul>
